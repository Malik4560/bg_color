...
function App() {
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-indigo-800 px-3 py-2 rounded-xl">
          <button 
          ...
          className="outline-10 px-4 py-1 rounded-full text-white shadow-lg" style={{backgroundColor:"gray"}}>Gray</button>
          <button 
